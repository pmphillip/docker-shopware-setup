 ...
 */
class Partner extends \Shopware\Models\Attribute\Partner implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'partnerId', 'partner'];
        }
    ...
    public function setPartnerId($partnerId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPartnerId', [$partnerId]);
