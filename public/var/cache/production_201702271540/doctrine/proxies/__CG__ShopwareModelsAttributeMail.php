 ...
 */
class Mail extends \Shopware\Models\Attribute\Mail implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'mailId', 'mail'];
        }
    ...
    public function getMailId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMailId', []);
    ...
    public function setMailId($mailId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMailId', [$mailId]);

        return parent::setMailId($mailId);
    }
